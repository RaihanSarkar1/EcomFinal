                        ...
                        <div class="row">
                                ...
                                <div class="product-gallery product-gallery-vertical">
                                    <div class="row">
                                        <figure class="product-main-image">
                                            <img id="product-zoom" src="{{ asset('storage/'.$product->photo)}}" data-zoom-image="assets/images/products/single/1-big.jpg" alt="product image">
                            ...
                            <div class="col-md-6">
                                <div class="product-details">
                                    ...
                                    <form action="{{ url('addToCart/'.$product->id) }}">
                                        <div class="details-filter-row details-row-size">
                ...
                <div class="row no-gutters bg-white newsletter-popup-content">
                    <div class="col-xl-3-5col col-lg-7 banner-content-wrap">
                        <div class="banner-content text-center">
                            ...
                            <p>Subscribe to the Amar tech eCommerce newsletter to receive timely updates from your favorite products.</p>
                            <form action="#">
