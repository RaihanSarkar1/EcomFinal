...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="amarTech">
    <meta name="application-name" content="AmarTech">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-9">
                            ...
                            <div class="products mb-3" id="product_list">
                                    ...
                                    <div class="row">
                                        <div class="col-6 col-lg-3">
                                            <figure class="product-media">
                                                ...
                                                <a href="{{url('product', $product->product_id===null? $product->id:$product->product_id)}}">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="product-body product-action-inner">
                                                ...
                                                <h3 class="product-title"><a href="{{url('product',$product->product_id===null? $product->id:$product->product_id)}}">{{ $product->name }}</a></h3><!-- End .product-title -->
                            ...
                            <nav aria-label="Page navigation">
                                <ul class="pagination">
                                    ...
                                    @for($i = $start; $i<= $end; $i++) <li class="page-item {{ $products->currentPage()==$i? 'active':''}}" aria-current="page"><a class="page-link" href="{{ $products->url($i) }}">{{ $i}}</a></li>
                                        @endfor
