                    ...
                    @if ($orders)
                        ...
                        @foreach($orders as $order)
                            <tr>
                                ...
                                <td>{{ $order->status }}</td>
                                <td>
                                    <a href="{{ url('order/approve/'.$order->id) }}"><button type="button" class="btn btn-blue">Approve</button></a>
                                    <a href="{{ url('order/cancel/'.$order->id) }}"><button type="button" class="btn btn-danger">Cancel</button></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
