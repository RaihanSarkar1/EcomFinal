...
<main class="main">
    ...
    <div class="container new-arrivals">
        <div class="heading heading-flex mb-3">
            ...
            <div class="heading-right">
                <ul class="nav nav-pills nav-border-anim justify-content-center" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="new-{{$category->name}}-link" data-toggle="tab" href="#new-{{ $category->name }}-tab" role="tab" aria-controls="new-{{$category->name}}-tab" aria-selected="false">{{ $category->name }}</a>
                    </li>
                    @endforeach
        ...
        <div class="tab-content tab-content-carousel just-action-icons-sm">
            ...
            @foreach($categories as $category)
            <div class="tab-pane p-0 fade" id="new-{{$category->name}}-tab" role="tabpanel" aria-labelledby="new-{{$category->name}}-link">
                <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" data-owl-options='{
                                "nav": true, 
                                "dots": true,
                                "margin": 20,
